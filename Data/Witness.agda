...
-- proper⸢W⸣ : 
--   ∀ {𝓁₁ 𝓁₁ʳ 𝓁₂ 𝓁₂ʳ} {A : Set 𝓁₁} {_R₁_ : relation 𝓁₁ʳ A} {B : Set 𝓁₂} {_R₂_ : relation 𝓁₂ʳ B} {{REX : Reflexive _R₁_}}
--   → _R₁_ ⇒⸢W⸣ _R₂_ → ⟪ _R₁_ ⇉ _R₂_ ⟫⸢W⸣
-- proper⸢W⸣ f = mk[witness] (λ x → witness-x f (mk[witness] x xRx)) (witness-proper f)
