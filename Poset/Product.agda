...
module _ {ℓ₁₁ ℓ₂₁ ℓ₁₂ ℓ₂₂} {A₁ : Poset ℓ₁₁} {A₂ : Poset ℓ₂₁} {B₁ : Set ℓ₁₂} {B₂ : Set ℓ₂₂} {{_ : PreOrder ℓ₁₂ B₁}} {{_ : PreOrder ℓ₂₂ B₂}} where
...
module _ {ℓ₁ ℓ₂ ℓ₃ ℓ₃ʳ ℓ₄} {A₁ : Set ℓ₁} {{_ : PreOrder ℓ₁ A₁}} {A₂ : Set ℓ₂} {{_ : PreOrder ℓ₂ A₂}} {B : Set ℓ₃} {_R_ : relation ℓ₃ʳ B} {C : Poset ℓ₄} where
