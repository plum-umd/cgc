...
β-Faexp[Var] {Γ} {x} {↑⟨ ρ ⟩} = ext[ω]⸢≈⸣ $ LHS , RHS
  where
...
β-Faexp[Unary]⸢⟐⸣ = ext[λ]⸢≈⸣ $ λ {ρ} → β-Faexp[Unary] {ρ = ρ}
...
β-Faexp[Binary]⸢*⸣⸢⊑⸣ = ext[ω]⸢⊑⸣ $ λ {n} → β-Faexp[Binary]⸢*⸣⸢⋿⸣ {n = n}
